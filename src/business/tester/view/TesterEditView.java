...
public class TesterEditView extends EditView{
	private static TesterEditView unique_instance;
	public static  TesterEditView getInstance(Composite parent){
		if (unique_instance==null){
			unique_instance=new TesterEditView(parent,SWT.NONE);//SWT.V_SCROLL|SWT.H_SCROLL|SWT.BORDER)
		}
	...
	private TesterEditView(Composite com,int style){
		//super(com,style);
