...
public class TLocalNodeView {
	private static TLocalNodeView unique_instance;
	public Composite parent=null;
	public Composite content=null;
	private SashForm sashForm=null;
	
	  public static TLocalNodeView getInstance(Composite parent){
	    if(unique_instance==null){
	      if(parent!=null){
	        unique_instance=new TLocalNodeView(parent);
	      }
	    }
	    return unique_instance;
	  }
	  
	  private TLocalNodeView(Composite com){
	    this.parent=com;
	    this.createAndShow();
	  }
			...
			btnOK.addSelectionListener(new SelectionListener() {
				...
				public void widgetSelected(SelectionEvent arg0) {
					 ...
					 if(StringUtil.isNullOrEmpty(ip)||
						StringUtil.isNullOrEmpty(name,30)||!StringUtil.isIp(ip)){
			...
			btnOK.addSelectionListener(new SelectionListener() {
				public void widgetSelected(SelectionEvent arg0) {
					...
					if(btnDbBackup.getSelection()){
					  ...
					  if(StringUtil.isNullOrEmpty(user,8)||
				 ...
				 if("Node".equals(type)){
					...
					if(!StringUtil.isNullOrEmpty(bean.getDbUser()))
					 ...
					 String dbpasswd=bean.getDbPasswd();
						...
						if(!StringUtil.isNullOrEmpty(bean.getBackdbname()))
							textBackDbName.setText(bean.getBackdbname());
