...
public class ReqSearchView {
	...
	public ReqSearchView(Composite com){
		this.parent=com;
	 		...
	 		public void mouseDown(MouseEvent e){}
	 		 public void mouseDoubleClick(MouseEvent e){
	 			 ...
	 			 if(currentItem!=null){
	 				...
	 				if(!DManagerEditView.getInstance(null).getTabState(tab)){
	 					ReqDetailView rdv=new ReqDetailView(DManagerEditView.getInstance(null).getTabFloder(),bean);
	 					DManagerEditView.getInstance(null).setTabItems(rdv.content, tab);
	 				}
	 			 }
	 		 }
	  }
