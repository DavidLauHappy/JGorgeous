...
public class DropAttachAction  implements DropTargetListener{
	
	public Table table;
	 List<ViewFileBean> DeleteFiles;
	public DropAttachAction(Table fileTable,List<ViewFileBean> deletes){
