...
public class SearchReqView {
	...
	public SearchReqView(Composite com){
		this.parent=com;
		 ...
		 if(reqs!=null&&reqs.size()>0){
			 for(TaskBean req:reqs){
				 ...
				 TableItem tableItem=new TableItem(resultTable,SWT.BORDER);
     	          tableItem.setText(new String[]{req.getCrtTime(),req.getReqID(),req.getOwnerShowName(),req.getTname(),step, appName, currUser}); 
	 		...
	 		public void mouseDown(MouseEvent e){}
	 		 public void mouseDoubleClick(MouseEvent e){
	 			 ...
	 			 if(currentItem!=null){
	 				...
	 				if(!DeveloperEditView.getInstance(null).getTabState(tab)){
	 					ReqDetailView rdv=new ReqDetailView(DeveloperEditView.getInstance(null).getTabFloder(),bean);
	 					DeveloperEditView.getInstance(null).setTabItems(rdv.content, tab);
	 				}
	 			 }
	 		 }
	  }
