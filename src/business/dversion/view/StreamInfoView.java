...
public class StreamInfoView {
	...
	private Map<String,ViewFileBean> StreamFiles;
	public boolean isAll=true;
	public StreamInfoView(Composite com,StreamBean data){
		 this.parent=com;
		 this.Data=data;
	...
	private void createToolsView(){
		...
		textDesc.setLayoutData(LayoutUtils.getComGridData(SWT.FILL, SWT.FILL, true, true, 6, 1, 0, 0));
		...
		/*Label labList=new Label(toolPanel,SWT.NONE);
		labList.setText(Constants.getStringVaule("label_list"));
		labList.setLayoutData(LayoutUtils.getComGridData(SWT.RIGHT, SWT.FILL, true, false, 2, 1, 0, 0));
		Text textList=new Text(toolPanel,SWT.BORDER|SWT.V_SCROLL|SWT.MULTI|SWT.LEFT|SWT.WRAP);
		textList.setLayoutData(LayoutUtils.getComGridData(SWT.FILL, SWT.FILL, true, true, 6, 1, 0, 0));
		String listText=DataHelper.getStreamViewStr(Data.getStreamID());
		textList.setText(listText);
		textList.setEditable(false);*/
		
		textInput=new Text(toolPanel,SWT.BORDER);
		textInput.setLayoutData(LayoutUtils.getComGridData(SWT.FILL, SWT.CENTER, true, false, 5, 1, 0, 0));
