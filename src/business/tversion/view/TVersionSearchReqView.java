...
import business.tversion.action.TVChooseUserAction;

public class TVersionSearchReqView {
	...
	public TVersionSearchReqView(Composite com){
		this.parent=com;
	 		...
	 		public void mouseDown(MouseEvent e){}
	 		 public void mouseDoubleClick(MouseEvent e){
	 			 ...
	 			 if(currentItem!=null){
	 				...
	 				if(!TVersionEditView.getInstance(null).getTabState(tab)){
	 					ReqDetailView rdv=new ReqDetailView(TVersionEditView.getInstance(null).getTabFloder(),bean);
	 					TVersionEditView.getInstance(null).setTabItems(rdv.content, tab);
	 				}
	 			 }
	 		 }
	  }
