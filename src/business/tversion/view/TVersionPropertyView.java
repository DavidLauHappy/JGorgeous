...
public class TVersionPropertyView {
	private ViewVersionBean data;
	private Point position=null;
	private  Shell property=null;
	
	public TVersionPropertyView(ViewVersionBean data){
		this.data=data;
	}
	...
	public  void showPropertyView(){
		...
		pannel.setLayoutData(LayoutUtils.getComGridData(SWT.FILL, SWT.FILL, true, true, 1, 1, 240, 150));
		...
		labName.setLayoutData(LayoutUtils.getComGridData(SWT.RIGHT, SWT.FILL, true, true, 2, 1, 0, 0));
		Text textName=new Text(pannel,SWT.BORDER);
		textName.setLayoutData(LayoutUtils.getComGridData(SWT.FILL, SWT.BEGINNING, true, true, 4, 1, 0, 0));
		...
		Text textDesc=new Text(pannel,SWT.BORDER|SWT.MULTI);
		...
		labUser.setLayoutData(LayoutUtils.getComGridData(SWT.RIGHT, SWT.FILL, true, true, 2, 1, 0, 0));
		Text textUser=new Text(pannel,SWT.BORDER|SWT.MULTI);
		textUser.setLayoutData(LayoutUtils.getComGridData(SWT.FILL, SWT.BEGINNING, true, true, 4, 1, 0, 0));
		...
		labTime.setLayoutData(LayoutUtils.getComGridData(SWT.RIGHT, SWT.FILL, true, true, 2, 1, 0, 0));
		Text textTime=new Text(pannel,SWT.BORDER|SWT.MULTI);
		textTime.setLayoutData(LayoutUtils.getComGridData(SWT.FILL, SWT.BEGINNING, true, true, 4, 1, 0, 0));
