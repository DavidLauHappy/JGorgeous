...
public class TVersionStreamInfoView {
	...
	public TVersionStreamInfoView(Composite com,StreamBean data){
		 this.parent=com;
		 this.Data=data;
	...
	private void createListView(){
		    ...
		    for(ViewFileBean file:Files){
		    	...
		    	if(StreamFiles.containsKey(fileName)){
		    		...
		    		long existTime=DateUtil.getTimeLong(existFile.getCrtTime());
		    		long time=DateUtil.getTimeLong(file.getCrtTime());
		    		if(time>existTime){
